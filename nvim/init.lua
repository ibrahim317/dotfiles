...
vim.api.nvim_set_keymap('i', '<M-h>', '<ESC>0i', {noremap = true})
-------------------------------------------------- [[ Highlight on yank ]]
-------------------------------------------------- [[ Highlight on yank ]]
-------------------------------------------------- [[ Highlight on yank ]]
-------------------------------------------------- [[ Highlight on yank ]]
...
local on_attach = function(_, bufnr)
  ...
  -- many times.
  --
  -- In trrs case, we create a function that lets us more easily define mappings specific
  -- for LlP related items. It sets the mode, buffer and description for us each time.
